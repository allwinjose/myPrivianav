...
<div class="tcs-text">
    ...
    healthcare.</p>
<div class="bside">
    <a href="https://www.priviahealth.com/" class="button2 btn-sec" target="_blank">LEARN MORE</a>
</div>
</div>
 </div> 
</div>
...
<div class="tcs2">
    <div class="tcs2-logo">
        ...
        <div class="tcs2-text">
<h2>Healthy for the long haul.</h2>
      ...
      <div class="row">
        <div class="large-12 columns">
          <div class="owl-carousel owl-theme">
            <div class="item center item-init init-logo">
             
<img src="<?php echo get_template_directory_uri(); ?>/img/new-header.png" alt="PH logog" class="mc">
    <div class="tcs-text-mob">
    <p>Our doctors are based in your community, centered on your needs, and part of a national network that’s transforming
    healthcare.</p>
<div class="center mob-lbt">
  <a href="https://www.priviahealth.com/" target="_blank"><button class="button2 btn-sec">LEARN MORE</button></a>
</div>
    </div>
 ...
 <p>You can enjoy personalized care without pricey membership fees. Our doctors take time to listen to your concerns, from wellness
    ...
    <div class="flexmenu">
        <div class="pri-menu">
            ...
            <div class="pmnavicon">
  <i  class="fas fa-ellipsis-v tog-mob"></i>
            </div>
        </div>
    </div>
    <!--mobile menu ends-->
...
<div class="ham-icon" >
    <i  class="fas fa-bars tog-mob-bot"></i><br>
